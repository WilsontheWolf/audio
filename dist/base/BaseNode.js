...
class BaseNode extends events_1.EventEmitter {
    constructor({ password, userID, shardCount, hosts, host }) {
        ...
        Object.defineProperty(this, "shardCount", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "voiceStates", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "voiceServers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "_expectingConnection", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Set()
